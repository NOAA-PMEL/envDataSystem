...
class POPS(HandixInstrument):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.lower_dp_bnd = [
            0.115, 0.125, 0.135, 0.15, 0.165, 0.185, 0.21, 0.25,
            0.35, 0.475, 0.575, 0.855, 1.22, 1.53, 1.99, 2.585
        ]
        self.uppder_dp_bnd = [
            0.125, 0.135, 0.15, 0.165, 0.185, 0.21, 0.25, 0.35,
            0.475, 0.575, 0.855, 1.22, 1.53, 1.99, 2.585, 3.37
        ]
